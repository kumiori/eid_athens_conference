...
\reporttitle{Europe in Discourse\\
\emph{Let's find a panel title}} % The report title to appear on the title page and page headers, do not create manual new lines here as this will carry over to page headers
